                        ...
                        <% } %>
                          ...
                          <div class="my-20">
                            ...
                            <div class=" flex justify-center items-center">
                              <div
                                ...
                                <% BookService service1=new BookService(); List<Book> recentbooks =
                                  service1.getRecentBook();
                          ...
                          <div class="my-20">
                            ...
                            <div class="flex justify-center items-center">
                              ...
                              <div
                                ...
                                <% BookService service2=new BookService(); List<Book> newbooks =
                                  service2.getNewBook();
                          ...
                          <div class="">
                            ...
                            <div class="flex justify-center items-center">
                              ...
                              <div
                                class="md:px-4 md:grid md:grid-cols-3 lg:grid-cols-5 gap-5 space-y-4 md:space-y-0 my-20">
                                <% BookService service3=new BookService(); List<Book> oldbooks =
                                  service3.getOldBook();
