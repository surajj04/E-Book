                                            ...
                                            <% } %>
                                                <div class="my-20">
                                                    ...
                                                    <div class=" flex justify-center items-center">
                                                        <div
                                                            class="md:px-4 md:grid md:grid-cols-3 lg:grid-cols-5 gap-5 space-y-4 md:space-y-0 my-20">

                                                            <% BookService service1=new BookService(); List<Book>
                                                                recentbooks =
                                                                service1.getAllRecentBook();
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="relative">
                                                                        <img class="w-40 h-40 rounded-xl"
                                                                            src="<%=b.getPhoto()%>" alt="Colors" />
                                                                    </div>
                                                                    <h1
                                                                        class="mt-4 text-gray-800 text-lg font-bold cursor-pointer">
                                                                        <%= b.getBookName() %>
                                                                    </h1>
                                                                    <div class="my-4">
                                                                        <div class="flex space-x-1 items-center">
                                                                            <span>
                                                                                <i
                                                                                    class="fa-solid fa-at text-indigo-600"></i>
                                                                            </span>
                                                                            <p>
                                                                                <%= b.getAuthor() %>
                                                                            </p>
                                                                        ...
                                                                        <div class="flex space-x-1 items-center">
                                                                            <span>
                                                                                <i
                                                                                    class="fa-solid fa-list text-indigo-600"></i>
                                                                            </span>
                                                                            <p>
                                                                                Recent Books
                                                                            </p>
                                                                        ...
                                                                        <div class="flex my-2">
                                                                            <button
                                                                                ...
                                                                                <span class="ml-1 self-center">Add
                                                                                    Cart</span>
                                                                            </button>
                                                                            <button
                                                                                ...
                                                                                <i class="fa-solid fa-circle-info"
                                                                                    style="color: #ffffff;"></i>
                                                                                <span
                                                                                    class="ml-1 self-center">Detail</span>
                                                                            </button>
                                                                            <button
                                                                                class="flex px-2 py-2 bg-red-600 mr-1 text-white font-semibold rounded text-xs my-auto items-center">
